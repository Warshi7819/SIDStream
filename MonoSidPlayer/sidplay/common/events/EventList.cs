...
namespace sidplay
{
    public class EventList : List<Event>
    {
        ...
        public EventList(Player player, EventScheduler context, BinaryReader reader)
            : base()
        {
        ...
        // deserializing
        protected void LoadFromReader(Player player, EventScheduler context, BinaryReader reader)
        {
